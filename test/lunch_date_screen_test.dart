...
void main() {
  ...
  testWidgets('Screen should have a date picker container', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: ChooseLunchDateScreen(),
    ));
  ...
  testWidgets('Screen should have a get ingredient button', (WidgetTester tester) async {
    await tester.pumpWidget(const MaterialApp(
      home: ChooseLunchDateScreen(),
    ));
